...
$string['pdftoppm_missing'] = 'The Poppler library tool (pdftoppm) is required for certimagegen features. If it is already installed on your server, please ignore it';
...
$string['sectionCertificates'] = 'Add the course for the section name to appear';
$string['sectionCertificates_desc'] = 'Which you want to use the section name in place of the course name or remove deselect the course, For multiple select courses use (ctrl+select)';
...
$string['here_is_the_certificate'] = 'Here is the certificate:';
$string['shared_certificate'] = 'Shared Certificate';

$string['my_certificate'] = 'My Certificate';
$string['download'] = 'Download';
$string['generatingimage'] = 'Generating image…';
$string['certificateShareURL'] = 'Certificate Share URL';
$string['nocertificate_moment'] = 'You have no certificates at the moment.';
$string['needtodownload_beforeshare'] = 'Certificate must be downloaded before it can be shared.';
$string['share'] = 'share';
$string['copy'] = 'Copy';
$string['copylink'] = 'Copy Link';
$string['certificate_img'] = 'Certificate img';
$string['selectcourseslink'] = 'Add New courses';
$string['selectcourse'] = 'Add courses';
