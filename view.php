...
if (!file_exists($imagepath)) {
    throw new moodle_exception('Certificate image not found.');
}

$PAGE->set_context(context_system::instance());
$PAGE->set_pagelayout('popup');
$PAGE->set_title('Shared Certificate');
$PAGE->set_url(new moodle_url('/local/certimagegen/view.php', ['code' => $code]));

echo '<!DOCTYPE html><html><head>';
echo '<meta property="og:title" content="Certificate of Achievement"/>';
...
echo '</head><body>';
echo '<h3>Here is the certificate:</h3>';
