...
🖼 Instant PNG generation when a learner views their certificate
...
🛠 Uses Poppler (pdftoppm / pdftocairo) for PDF → PNG conversion
...
Plugin detects PDF and creates a PNG image using Poppler
