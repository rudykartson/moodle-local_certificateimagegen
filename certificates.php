...
$PAGE->set_title(get_string('my_certificate','local_certimagegen'));
...
$data = [
    'wwwroot'            => $CFG->wwwroot,
    'needtodownload_beforeshare'      => get_string('needtodownload_beforeshare','local_certimagegen'),
    'nocertificate_moment'            => get_string('nocertificate_moment','local_certimagegen'),
    'share'                           => get_string('share','local_certimagegen'),
    'copy'                            => get_string('copy','local_certimagegen'),
    'copylink'                        => get_string('copylink','local_certimagegen'),
